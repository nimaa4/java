...
public class CheckPackage extends JFrame{
    ...
    CheckPackage() {    
      ...
      setVisible(true);
      String[] package1 = new String[]{"package1.jpg","Bali, Indonesia","6 days and 7 Nights", "Half Day City Tour", "Welcome drinks on Arrival", "Daily Buffet", "Full Day 3 Island Cruise", "English Speaking Guide", "BOOK NOW", "Summer Special", "Rs 22000 only"};
      String[] package2 = new String[]{"nyc.jpeg","New York, USA","4 days and 3 Nights", "Meet and Greet at Aiport", "Welcome drinks on Arrival", "Night Safari", "Full Day 3 Island Cruise", "Cruise with Dinner", "BOOK NOW", "Winter Special", "Rs 50000 only"};
      String[] package3 = new String[]{"bern.jpeg","Bern, Switzerland","6 days and 5 Nights", "Free Clubbing, Horse Riding & other Games", "Welcome drinks on Arrival", "Daily Buffet", "Stay in 5 Star Hotel", "Full Three course Meal", "BOOK NOW", "Winter Special", "Rs 32000 only"};
      String[] package4 = new String[]{"sydney.jpeg","Sydney, Australia","7 days and 6 Nights", "Safari,Snorkling, Air diving &Bungee jumping", "Cruise", "Free Breakfast", "Stay in 5 star hotel", "BBQ Dinner", "BOOK NOW", "Autumn Special", "Rs 47000 only"};
